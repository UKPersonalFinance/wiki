...
description: Draft guide to current accounts, account switching, and building a banking ecosystem.
draft: true
---

## What are Current Accounts

TEXT PLAGARISED FROM MSE, NEEDS FIXING
...
## Which current accounts should you go for? What are the best ones? What are the differences?

## Current account switching

Sometimes banks offer bonuses to those who switch to them from another account. This may include a lump sum payment if you meet certain criteria or an ongoing reward.

To switch you generally need to close an existing account in the process. If you do not wish to close your main current account you can create a new one purely for the benefit of switching.

Often you need to fulfill minimum pay in requirements (which could be from another of your own accounts rather than a salary, and can be moved elsewhere again shortly after) and a certain number of direct debits.

Moneysaving expert provides a list of the current switching bonuses https://www.moneysavingexpert.com/banking/compare-best-bank-accounts/#switch

r/beermoneyuk also has a guide of this. See here: add link to bankedex

OLD TEXT BELOW FROM A PAGE TITLED CURRENT ACCOUNTS AND CREDIT CARDS, SUGGEST DELETING
...
I welcome your feedback and any ways you see that this can be improved. Thank you to the [original thread commenters](https://www.reddit.com/r/UKPersonalFinance/comments/5hd6oj/has_anyone_else_tried_switching_current_accounts/) for the suggestions, and in particular to [emorrp1](https://www.reddit.com/user/emorrp1) for his contributions included in the guide.
...
Lloyds Club 2DD's -> The Week Subscription + [Little Debits](https://littledebits.co.uk/)

Halifax -> 2 DD's -> [Little Debits](https://littledebits.co.uk/) x2
