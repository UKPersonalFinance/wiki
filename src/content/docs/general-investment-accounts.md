...
If you've used your ISA allowance, but still have money left to invest, you may be considering using a GIA (a taxable investment account). These have no limits on your contributions or withdrawals, but your investments are subject to tax. This not only costs money, but is extra work to track and report. 
...
Interest received from investments (typically bond funds, gilts, and any cash sitting uninvested in the account) is charged at your usual income tax rate, after any earned income but before dividends. 
...
It is also not always possible to buy 'fractional shares' of an ETF, unless the broker supports them, whereas all brokers support fractional unit purchases of OEICs, which may lend itself better to regular investing.
...
The simplest approach is to use a spreadsheet, which captures the date of transaction, number of units, and total cost of each purchase and sale, including any dealing charges and stamp duty (if applicable) paid. 

If ERI or equalisation applies, this also needs adding as a separate line item.
