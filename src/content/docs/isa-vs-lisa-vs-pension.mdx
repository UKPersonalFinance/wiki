...
You pay into an [ISA](/isa/) from your net pay – you've already paid income tax and
...
would work out exactly the same. ([No really!](/isa-vs-lisa-vs-pension/#why-timing-of-tax-relief-doesnt-matter)).
...
- If you are a [higher rate taxpayer](https://www.gov.uk/income-tax-rates) or above, you could receive 40% income
  tax relief (or more) on the way in, but pay only 20% tax on the way out.
- You also have a [personal allowance](https://www.gov.uk/income-tax-rates) which means you do not have to pay any
...
buy your first home see [our dedicated page](/lisa/) on that.
...
You can refer to the [reddit post linked to above](https://www.reddit.com/r/UKPersonalFinance/comments/19d0piv/psa_pension_tax_efficiency_return_on_investment/) for the exact
calculations.
...
| Age funds can be withdrawn             | Age 55-57 (check with your pension provider for specific terms)                                                              | Any time                                                                  | Age 60, or earlier with a [penalty](/lisa/#when-can-i-access-the-money).  |
