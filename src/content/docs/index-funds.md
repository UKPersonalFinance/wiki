...
If you're used to thinking of investing as picking the best companies or [timing your buying and selling](/market-timing/), buying a fund which invests in 'a bit of everything' and holding it for years might not sound like what you think 'investing' is about. However it's actually the strategy with the best evidence behind it.
...
There's very often another benefit to index funds. Due to their simplicity - a single, unchanging aim of tracking their index - they are almost always **cheaper than actively-managed funds.** We have a page on why fees matter [here](/fees/)- small differences in fees matter a lot over decades.
...
Examples of popular global indices are: the FTSE All-World, FTSE Global All-Cap, and MSCI All-Country World Index.
...
If you're investing in a [S&S ISA](/isa/), [S&S LISA](/lisa/) or [pension](/isa-vs-lisa-vs-pension/), using an accumulation fund is generally preferable to reinvesting dividends manually as it saves you the hassle and delays (and fees if applicable). However if you are investing in a taxable account, using income funds makes tracking your tax liabilities easier.

#### Fund vs ETF {#fund_vs_etf}

Index funds can be either [open-ended funds](https://www.investopedia.com/terms/o/open-endfund.asp) (generally referred to simply as "funds"), or [Exchange-Traded funds](https://www.investopedia.com/terms/e/etf.asp) ("ETFs"). You will also see references throughout the investing world to “mutual funds”, OEICs, Unit Trusts, and SICAVs. These are all types of open-ended fund.

For long-term index investing, funds and ETFs do basically the same job. The main differences are:

- ETFs are traded on a stock exchange throughout the day, like individual stocks are. Funds meanwhile are traded over the counter once a day
- Most brokers will not allow you to buy 'fractional shares' of an ETF. So if one share of the ETF is e.g. £91, you will only be able to buy in multiples of that
- Some brokers charge different fees for trading ETFs vs funds

If you're interested in more technical detail on how funds are structured, see the [funds Q&A](/uk-funds-faq/#wait-whats-an-exchange-traded-fundicvc).
...
| [Vanguard FTSE Global All Cap (Acc) (VAFTGAG)](https://www.trustnet.com/factsheets/o/ngly/vanguard-ftse-global-all-cap-index) | Fund | 0.23%               | FTSE Global All Cap Index [(pdf factsheet)](https://research.ftserussell.com/Analytics/Factsheets/Home/DownloadSingleIssue?issueName=GEISLMS&isManual=False) |
| [Vanguard FTSE Global All-Cap UCITS ETF (VALL)](https://www.vanguardinvestor.co.uk/investments/vanguard-ftse-global-all-cap-ucits-etf-usd-acc/overview) | ETF  | 0.07%               | FTSE Global All Cap Index [(pdf factsheet)](https://research.ftserussell.com/Analytics/Factsheets/Home/DownloadSingleIssue?issueName=GEISLMS&isManual=False) |
...
The Bogleheads wiki has a [useful list of Sharia-compliant funds](https://www.bogleheads.org/wiki/Sharia_investing_for_non-US_investors).
...
You can read more about this in [Vanguard's whitepaper on global equity investing](https://web.archive.org/web/20201218020518/https://www.vanguard.com/pdf/ISGGEB.pdf).
...
It's also worth knowing that as with any multi-fund portfolio, if you want to maintain a particular ratio between the funds, you will need to periodically [re-balance](https://monevator.com/the-simplest-way-to-rebalance-your-portfolio/) as some will grow faster than others.

## Setting up an account

[What type of investment account should I open?](/investing-101/#what-type-of-investment-account-should-i-use)

[Which broker should I open an account with?](/which-broker-should-i-use/)
