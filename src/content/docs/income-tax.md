...
The current rates for income tax in England, Wales and Northern Ireland, can be found on the Government website [here](https://www.gov.uk/income-tax-rates). There are different rates if you live in [Scotland](https://www.gov.uk/scottish-income-tax).
...
HMRC have a very comprehensive guide on what all the different letters mean in your tax code [here.](https://www.gov.uk/employee-tax-codes/letters)
...
The system for PAYE calculates tax based on the cumulative pay you have received to date. If you have one month with an unusually large pay (e.g. from a bonus) then this can result in you overpaying tax in that month as the cumulative amount earned to date is out of line with previous months.
...
**Not all workplace benefits are taxable**. You can find information on this [on gov.uk](https://www.gov.uk/tax-company-benefits). One of the most common workplace benefits that is not taxable is "group death-in-service" schemes - life insurance provided by your employer, usually based on a multiple of your salary. Confusingly, this isn't mentioned on the linked gov.uk information page.
...
Most employees with straightforward tax affairs do not need to complete a tax return. As we mention in our [Savings Accounts](/savings/) page, if your taxable savings income exceeds £10,000 you will need to.

Other times that you may need to are detailed on[this gov.uk help page](https://www.gov.uk/self-assessment-tax-returns/who-must-send-a-tax-return).

### How can I work out what my take home pay should be?

If you are looking at changing jobs, or have recently been promoted, you may want to estimate what your take-home pay should be. There are lots of net pay calculators online but the two that get most recommendations from the subreddit are [Listen to Taxman](https://listentotaxman.com/) and [The Salary Calculator](https://www.thesalarycalculator.co.uk/).
...
The HMRC personal tax account page can be accessed here: [https://www.gov.uk/personal-tax-account](https://www.gov.uk/personal-tax-account).
...
There are other classes of National Insurance. The self-employed pay Class 2 or Class 4, and you can choose to pay voluntary Class 3 contributions to maintain a state pension record if you do not earn enough otherwise. You can [find more details on gov.uk](https://www.gov.uk/national-insurance).

## Tax on Savings and Investments

We go into lots of detail about tax on cash savings on the [Savings Accounts](/savings/) page.
