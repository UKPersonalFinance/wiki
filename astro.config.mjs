      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Mortgage overpayments vs investments",
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Investing for your children",
              slug: "investing-for-your-children",
            },
            {
              label: "Which broker should I use?",
              slug: "which-broker-should-i-use",
            },
            {
              label: "FSCS Protection",
              slug: "fscs-protection-for-investments",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: "Tax Traps and Tax Efficiency",
              slug: "tax-traps-and-tax-efficiency",
            },
            { label: "RSUs", slug: "rsu" },
            {
              label: "Gifts and Inheritance Tax",
          ...
          items: [
            ...
            { label: "UK income and wealth statistics", slug: "statistics" },
            {
              ...
              items: [
                ...
                {
                  label: "Is this wiki advice?",
                  slug: "this-wiki-is-not-advice",
                },
              ],
            },
